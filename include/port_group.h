...
namespace midimagic {
    ...
    public:
        ...
        void add_port_group(const demux_type dt,
    ...
    class port_group {
    public:
        explicit port_group(const u8 id,const demux_type dt,
                            const midi_message::message_type msg_type, const u8 channel);
        ...
        void add_midi_input(const midi_message input_type);
        void remove_msg_type(const midi_message input_type);
